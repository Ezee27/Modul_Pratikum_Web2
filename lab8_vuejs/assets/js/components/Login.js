const Login = {
    ...
    methods: {
        handleLogin() {
            axios.post('http://localhost:8080/index.php/api/login', {
            ...
            .catch(error => {
                if (error.response && error.response.data && error.response.data.messages) {
                    ...
                    this.errorMessage = "Eror 500: Masalah pada server CodeIgniter.";
                    console.error("Detail Eror 500:", error.response.data);
                } else {
                    this.errorMessage = 'Terjadi kesalahan jaringan. Pastikan php spark serve menyala.';
